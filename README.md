...
1. 访问网站，点击右上角的 **"申请软件"** 按钮
2. 填写软件名称和补充说明
3. 提交后系统会自动创建 GitHub Issue
4. 等待管理员审核处理

详细说明请查看 [软件申请功能文档](docs/SOFTWARE_REQUEST_FEATURE.md)
...
5. 根据下载方式添加内容：
   ...
   - **官网下载**：创建 `link.txt` 文件，内容为官方下载页面 URL
