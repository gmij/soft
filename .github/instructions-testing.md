...
- 空目录处理
- 特殊字符文件名
- readme.md 优先级（版本目录有 readme.md）
- readme.md 回退（版本目录无 readme.md，使用软件目录的）
...
- 多个软件
- P2P 和直接下载混合
- readme.md 在软件目录（作为默认描述）
- readme.md 在版本目录（优先使用）
- 边界情况（空目录、无效结构）
```
